...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveOcrApiClientAsync.FormTableDefinition();
  });
  ...
  describe('FormTableDefinition', function() {
    it('should create an instance of FormTableDefinition', function() {
      ...
      //var instane = new CloudmersiveOcrApiClientAsync.FormTableDefinition();
      //expect(instance).to.be.a(CloudmersiveOcrApiClientAsync.FormTableDefinition);
    });
