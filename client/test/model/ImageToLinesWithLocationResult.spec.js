...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveOcrApiClientAsync.ImageToLinesWithLocationResult();
  });
  ...
  describe('ImageToLinesWithLocationResult', function() {
    it('should create an instance of ImageToLinesWithLocationResult', function() {
      ...
      //var instane = new CloudmersiveOcrApiClientAsync.ImageToLinesWithLocationResult();
      //expect(instance).to.be.a(CloudmersiveOcrApiClientAsync.ImageToLinesWithLocationResult);
    });
