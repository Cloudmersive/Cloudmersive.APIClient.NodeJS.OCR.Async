...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveOcrApiClientAsync.ImageToTextResponse();
  });
  ...
  describe('ImageToTextResponse', function() {
    it('should create an instance of ImageToTextResponse', function() {
      ...
      //var instane = new CloudmersiveOcrApiClientAsync.ImageToTextResponse();
      //expect(instance).to.be.a(CloudmersiveOcrApiClientAsync.ImageToTextResponse);
    });
