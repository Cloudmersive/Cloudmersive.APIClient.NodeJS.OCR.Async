...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveOcrApiClientAsync.OcrPageResult();
  });
  ...
  describe('OcrPageResult', function() {
    it('should create an instance of OcrPageResult', function() {
      // uncomment below and update the code to test OcrPageResult
      //var instane = new CloudmersiveOcrApiClientAsync.OcrPageResult();
      //expect(instance).to.be.a(CloudmersiveOcrApiClientAsync.OcrPageResult);
    });
