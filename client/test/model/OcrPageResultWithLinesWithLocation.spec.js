...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveOcrApiClientAsync.OcrPageResultWithLinesWithLocation();
  });
  ...
  describe('OcrPageResultWithLinesWithLocation', function() {
    it('should create an instance of OcrPageResultWithLinesWithLocation', function() {
      // uncomment below and update the code to test OcrPageResultWithLinesWithLocation
      //var instane = new CloudmersiveOcrApiClientAsync.OcrPageResultWithLinesWithLocation();
      //expect(instance).to.be.a(CloudmersiveOcrApiClientAsync.OcrPageResultWithLinesWithLocation);
    });
