...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveOcrApiClientAsync.PdfToTextResponse();
  });
  ...
  describe('PdfToTextResponse', function() {
    it('should create an instance of PdfToTextResponse', function() {
      // uncomment below and update the code to test PdfToTextResponse
      //var instane = new CloudmersiveOcrApiClientAsync.PdfToTextResponse();
      //expect(instance).to.be.a(CloudmersiveOcrApiClientAsync.PdfToTextResponse);
    });
