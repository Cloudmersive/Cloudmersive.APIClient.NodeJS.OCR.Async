...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveOcrApiClientAsync.PdfToWordsWithLocationResult();
  });
  ...
  describe('PdfToWordsWithLocationResult', function() {
    it('should create an instance of PdfToWordsWithLocationResult', function() {
      ...
      //var instane = new CloudmersiveOcrApiClientAsync.PdfToWordsWithLocationResult();
      //expect(instance).to.be.a(CloudmersiveOcrApiClientAsync.PdfToWordsWithLocationResult);
    });
