...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveOcrApiClientAsync.PhotoToWordsWithLocationResult();
  });
  ...
  describe('PhotoToWordsWithLocationResult', function() {
    it('should create an instance of PhotoToWordsWithLocationResult', function() {
      ...
      //var instane = new CloudmersiveOcrApiClientAsync.PhotoToWordsWithLocationResult();
      //expect(instance).to.be.a(CloudmersiveOcrApiClientAsync.PhotoToWordsWithLocationResult);
    });
