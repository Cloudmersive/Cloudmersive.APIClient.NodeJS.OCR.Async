...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveOcrApiClientAsync.Point();
  });
  ...
  describe('Point', function() {
    it('should create an instance of Point', function() {
      ...
      //var instane = new CloudmersiveOcrApiClientAsync.Point();
      //expect(instance).to.be.a(CloudmersiveOcrApiClientAsync.Point);
    });
