...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveOcrApiClientAsync.TableCellResult();
  });
  ...
  describe('TableCellResult', function() {
    it('should create an instance of TableCellResult', function() {
      ...
      //var instane = new CloudmersiveOcrApiClientAsync.TableCellResult();
      //expect(instance).to.be.a(CloudmersiveOcrApiClientAsync.TableCellResult);
    });
