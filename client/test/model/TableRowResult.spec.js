...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveOcrApiClientAsync.TableRowResult();
  });
  ...
  describe('TableRowResult', function() {
    it('should create an instance of TableRowResult', function() {
      ...
      //var instane = new CloudmersiveOcrApiClientAsync.TableRowResult();
      //expect(instance).to.be.a(CloudmersiveOcrApiClientAsync.TableRowResult);
    });
